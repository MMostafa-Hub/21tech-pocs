Ext.define('EAM.custom.AddButtonOnFocus', {
    ...
    // Cache for LVCAT (category) data
    // Initialize this on the instance. If getSelectors is called multiple times
    // for different instances, each will have its own cache.
    // If EAM.custom.AddButtonOnFocus is a singleton or used once, this is fine.
    // Alternatively, initialize in an initComponent or constructor if available.
    cachedLvCatData: {
        params: null, // Stores the parameters {organization, class, classorganization}
