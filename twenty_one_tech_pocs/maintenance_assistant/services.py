...
class MaintenanceAssistantService:
    ...
    def process_document(self, file: UploadedFile) -> MaintenanceSchedule:
        """
    ...
    def _get_system_prompt_template(self) -> str:
        ...
        All durations should be in hours or days format (e.g., "2 hours", "3 days").
        Generate unique IDs for each entity (plan_id, checklist_id) in a consistent format.
        Each checklist must include relevant safety requirements, tools, and completion steps.
        """
    ...
    def _process_maintenance_data(self, llm: ChatOpenAI, documents: list[Document]) -> MaintenanceSchedule:
        ...
        parser = JsonOutputParser(pydantic_object=MaintenanceSchedule)
